"""
Universal configuration for the tube + ball X-ray change detection project.
...
ADD_CONSOLIDATION = False  # Generate a consolidation/mass in the CT volume
...
# --- FIX FOR MULTIPROCESSING NFS CRASHES ---
# 1. Force joblib to use local RAM for shared memory arrays to prevent "double free or corruption"
...
if ADD_TUBE:
    ROI_SUBSET.append("trachea")

# ==============================================================================
# DATA GENERATION — MASS & DEFORMATION
# ==============================================================================
...
# Mass Probabilities
ADD_MASS_PRIOR_PROBABILITY = 0.7
ADD_MASS_CURRENT_PROBABILITY = 0.7

# Tube Probabilities
ADD_TUBE_PRIOR_PROBABILITY = 0.7
ADD_TUBE_CURRENT_PROBABILITY = 0.7
