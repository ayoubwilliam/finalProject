...
# 3. Prevent C-level Segmentation Faults from Thread Contention
# When multiprocessing workers try to spawn their own internal OpenMP threads, it causes a stack overflow/segfault.
...
TRACHEA_SEG_SUFFIX = "_full_airway_v2"
