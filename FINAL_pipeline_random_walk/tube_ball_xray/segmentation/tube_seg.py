"""
Trachea segmentation using TotalSegmentator.
Generates and caches a trachea airway mask for tube insertion.
Based on tube_test6/seg.py.
"""
...
def generate_full_airway_mask(ct_path, segs_dir):
    ...
    final_save_path = os.path.join(segs_dir, base_name + cfg.TRACHEA_SEG_SUFFIX + cfg.NIFTI_EXTENSION)
